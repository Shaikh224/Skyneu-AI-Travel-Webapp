...
> ⚠️ **Security note:** Any variable prefixed with `VITE_` is bundled into the client and exposed to browsers. Never put private secrets (Amadeus, Perplexity, Gemini server keys, Dodo Payments keys/webhook secrets) behind `VITE_` — keep those in Appwrite Function environment variables or your backend proxy. See [`SECURITY.md`](./SECURITY.md) for full details.
...
🔗 Live app: [skyneu.com](https://skyneu.com) · 📦 Repo: [Skyneu-AI-Travel-Webapp](https://github.com/Shaikh224/Skyneu-AI-Travel-Webapp)
## 🌟 Overview
